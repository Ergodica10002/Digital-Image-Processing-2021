...
cv2.imwrite("hw2_result_images/result1.jpg", result1_img)
#end of a1
...
cv2.imwrite("hw2_result_images/result2.jpg", result2_img)
#end of a2
...
cv2.imwrite("hw2_result_images/result3.jpg", result3_img)
